...
## we will cahnge here the path of new models if we are using the other algorithm 

model_file_path= r"C:\Users\codin\OneDrive\Desktop\customer_satisfaction\models\logisticregre.lb"
...
def home():
    return render_template('home.html')   # will generate the url 
...
@app.route('/cancelbooking')  # http://127.0.0.1:5000/cancelbooking
def cancelbooking():
